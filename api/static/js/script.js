...
function checkTeamSelection() {
  ...
  if (oppTeam === '' && myTeam === '') {
    ...
    return;
  } else if ((oppTeam !== '' && myTeam === '') || (oppTeam === '' && myTeam !== '')) {
...
function sendMail(contactForm) {
  ...
  emailjs
    .send('service_jc6wj58', 'soccerpredictorapp', {
      ...
      senders_name: contactForm.sendersName.value,
    })
    .then(
      function (response) {
...
$(document).ready(function () {
  ...
  document.getElementById('share').onclick = function () {
    ...
    let sendersName = document.getElementById('sendersName').value;
    let btn = $(this);
    if (friendsName && friendsEmail && sendersName !== '') {
...
function clearValue() {
  ...
  let chance_x = (document.getElementById('my_Chances').innerHTML = currentQuery);
  let chance_y = (document.getElementById('opp_Chances').innerHTML = currentQuery);
